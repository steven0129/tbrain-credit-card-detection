...
class FeatureHashing():
    def __init__(self, train_set, test_set):
        ...
        self.svd = TruncatedSVD(n_components=1000, algorithm='arpack')
    ...
    def training_set(self):
        ...
        conam = self.conam_enc.fit_transform(X['conam'].values.reshape(-1, 1)).astype('float16')
        ...
        for key in keys:
            X[key] = self.label_encs[key].fit_transform(X[key].values)
